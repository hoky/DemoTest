...
price_start = 0.20
num_invest = float(raw_input("请输入当前是入场的第几天： "))
growth_rate = float(raw_input("请输入日涨幅： "))

#入场GHC价格
price_stage = price_start * (1+ growth_rate * num_invest)
print("基础价格： " + str(price_stage))

coin_count_daily = float(raw_input("请输入每日挖币量基数： "))
